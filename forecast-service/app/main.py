...
from app.router import forecast, health, whatif
...
def create_app() -> FastAPI:
    app = FastAPI(
        ...
        description="Deterministic financial forecasting service for Tekimax.",
        docs_url="/docs",
    )
    ...
    logger.info("Forecast service v%s starting", settings.app_version)
    return app
